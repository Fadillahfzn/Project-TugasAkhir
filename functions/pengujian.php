...
// // if ($query->rowCount() == 0) {
// //     $insertQuery = "INSERT INTO riwayat (created_at, true_positive, positive_netral, false_positive, true_netral, true_negative, negative_netral, netral_positive, netral_negative, data_testing, data_training, data_training_positive, data_training_negative, data_training_netral, predict_positive, predict_negative, predict_netral, vocabulary, vocab_weight) VALUES (:created_at, :true_positive, :positive_netral, :false_positive, :true_netral, :true_negative, :negative_netral, :netral_positive, :netral_negative, :data_testing, :data_training, :data_training_positive, :data_training_negative, :data_training_netral, :predict_positive, :predict_negative, :predict_netral, :vocabulary, :vocab_weight)";
