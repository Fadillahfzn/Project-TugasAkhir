          ...
          <i class="mdi mdi-close"></i>
            ...
            <div class="left-side-logo d-block d-lg-none">
                <div class="text-center">
                    <a href="index.html" class=""><img src="" height="" alt="" /></a>
                </div>
            </div>
            ...
            <div class="sidebar-inner slimscrollleft">
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="importdata.html" class="waves-effect">
                                <i class="dripicons-home"></i> Import Data
                                <span class="badge badge-success badge-pill float-right"></span>
                            </a>
                        </li>
                        <li>
                            <a href="preprocessing.html" class="waves-effect">
                                <i class="dripicons-home"></i> Preprocessing
                                <span class="badge badge-success badge-pill float-right"></span>
                            </a>
                        </li>
                        <li>
                            <a href="labelling.html" class="waves-effect">
                                <i class="dripicons-home"></i> Labeling
                                <span class="badge badge-success badge-pill float-right"></span>
                            </a>
                        </li>
                        <li>
                            <a href="splitdata.html" class="waves-effect">
                                <i class="dripicons-home"></i> Split Data
                                <span class="badge badge-success badge-pill float-right"></span>
                            </a>
                        </li>
                        <li>
                            <a href="modelling.html" class="waves-effect">
                                <i class="dripicons-home"></i> Modelling
                                <span class="badge badge-success badge-pill float-right"></span>
                            </a>
                        </li>
                        <li>
                            <a href="pengujian.html" class="waves-effect">
                                <i class="dripicons-home"></i> Pengujian
                                <span class="badge badge-success badge-pill float-right"></span>
                            </a>
                        </li>
                        <li>
                            <a href="visualisasidata.html" class="waves-effect">
